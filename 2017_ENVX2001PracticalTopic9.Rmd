...
```{asis, echo = F}
Both L10Area and GRAZE are highly significant, L10AREA is the most significant. in terms of effect, a 1 unit change in GRAZE results in a -2.8 decrease in abundance, while a 1 unit change in L10AREA, so a 10 unit change in AREA, results in a 6.9 increase in abundance (CHECK THIS). 
```
